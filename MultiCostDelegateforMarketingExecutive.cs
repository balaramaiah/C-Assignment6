...
namespace MarketingExecutiveMultiCastDelegate
{
    ...
    class MarketingExecutive : Employee
    {
        ...
        public void CalculateSalary2(int empid, string empname, double sal, double kmt)
        {
            ...
            Console.WriteLine("MarketingExecutive Name :" + empname);
            Console.WriteLine("MarketingExecutive Salary :" + sal);
            Console.WriteLine("MarketingExecutive Kilometer Travels :" + kmt);
